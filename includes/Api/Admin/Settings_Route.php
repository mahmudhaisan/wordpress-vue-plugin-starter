<?php
namespace WpVue\Starter\Api\Admin;
...
class Settings_Route extends WP_REST_Controller
{
    ...
    {
        $response = [
            'firstname' => get_option('wpvue_settings_firstname', true),
            'lastname' => get_option('wpvue_settings_lastname', true),
            'email' => get_option('wpvue_settings_email', true),
        ];
    ...
    public function create_items($request)
    {
        ...
        update_option('wpvue_settings_firstname', $firstname);
        update_option('wpvue_settings_lastname', $lastname);
        update_option('wpvue_settings_email', $email);
